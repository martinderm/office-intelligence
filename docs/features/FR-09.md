...
status: geplant-human-gate
summary: Hashgebundene Approval-Receipts und read-only Promotion-Preflight für die Cloud-Übergabe des attachment_filing_candidate.
packages: [MD-P1 (Approval + Preflight), MD-P2 (atomarer Storage-Writer), MD-P3 (Cloud-Atlas-Handoff + Mirror)]
next_package: MD-P1 nach ausdrücklicher Human-Freigabe
blocker: Human Gate: keine Promotion ohne explizite Freigabe
