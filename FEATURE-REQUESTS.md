...
| `FR-17` | 🟡 teilweise; MD-R1, MD-R2, MD-R6, MD-R7, MD-R3 und MD-R4 abgeschlossen und paketabgenommen (katalogtreues Routing, DNR-gegatete Sibling-Kohärenz, begrenzte Client-Deadlines, Verify-Scope/Provenienz/Evidence, deterministische MIME-Inventarkette, Inline-Bild-Policy; 887 Tests grün, Reviews approve) | B-1/B-2/B-8/B-9/B-10/B-3/B-4/B-5 behoben; `classifier_revision` rotiert (MD-R1, MD-R2, MD-R3 — je genau einmal, genehmigt); DNR-Owner, Sibling-Gate, `overall_deadline_seconds`, Subset-Verify-Scope mit Runner-Provenienz, kanonischer Evidence-Fallback, Trigger-/Konsistenz-Gate, Bild-MIME-Exklusion ohne Extrakt | `MD-R5` |
