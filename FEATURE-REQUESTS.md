...
| `FR-17` | 🟡 teilweise; MD-R1 und MD-R2 abgeschlossen und paketabgenommen (Routing-Priorität, Exaktcode-vor-Kontakt, DNR für Projekte+Topics, Newsletter-Mapping, suppressed_candidates; DNR-gegatete Sibling-Kohärenz; 848 Tests grün, Reviews approve) | B-1/B-2 behoben; `classifier_revision` zweimal rotiert (MD-R1, MD-R2 — je genau einmal, genehmigt); `evaluate_do_not_route_signal` als kanonischer DNR-Owner, `evaluate_thread_sibling_do_not_route` für Siblings | `MD-R6` |
