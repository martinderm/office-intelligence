...
| `FR-17` | 🟡 teilweise; MD-R1 abgeschlossen und paketabgenommen (Routing-Priorität, Exaktcode-vor-Kontakt, DNR für Projekte+Topics, Newsletter-Mapping, suppressed_candidates; 836 Tests grün, Review approve nach Fix-Runde 1) | B-1/B-2 behoben; `classifier_revision` genau einmal rotiert (genehmigt); `evaluate_do_not_route_signal` als kanonischer DNR-Owner in `project_matching.py` | `MD-R2` (nach R1) |
