...
| `FR-04` | 🟡 in Arbeit — FR-04a/b abgeschlossen | Ja: kataloggestützter Dossier-Manifest- und Review/Apply-Pfad | `batch-dossier.json` bereitet einen begrenzten Inspect-Auftrag vor; `dossier_apply` führt nur einen separat geprüften, hashgebundenen Routingauftrag über Execute→Verify aus. Synthese und Cloud-/Task-Handover folgen getrennt in FR-04c–d. |
