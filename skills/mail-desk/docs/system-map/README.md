...
> **Ziel**: Kompakte, zitierbare Architekturkarte der Mail-Desk-Engine (reproduzierbare Git-Index-Metrik via `git ls-files`: 110 getrackte Dateien; 54 getrackte Dateien unter `scripts/`, davon 43 unter `scripts/core`; 41 Testmodule; 705 Tests) zur Vermeidung von Context-Bloat und Attention Drift bei Refactorings, Quarantäne-Erweiterungen und Bugfixes.
...
## 5. FR-15/MD-E2-T01 + T02 + T03 — Draft-Integration, Neuklassifikation und opt-in inspect-Vorschlag
...
Reihenfolge und bleibt item-lokal. MD-E2-T04 (Paketabnahme) ist noch offen;
FR-15 insgesamt bleibt offen. Details:
