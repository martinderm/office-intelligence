...
| Der Claim „keine Massenpipeline“ im Frontmatter steht neben Batch-Runner-, `pipeline`- und autonomen Batchdetails. | Frontmatter, Arbeitsfluss/Grundregeln, `batch-runner.md` | Produkt-/Scope-Entscheidung erforderlich; nicht still durch OI-14a–d ändern. |
