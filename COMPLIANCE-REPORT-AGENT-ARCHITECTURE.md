...
| `OI-14c` | ✅ abgeschlossen | Manifest- und Compliance-Details auslagern | `mail-desk/SKILL.md`, neue Referenzen | Formate und Sicherheitsregeln ohne Verlust verlinkt | `OI-14b` | Implementierung und Parent-Review abgeschlossen; neue `cli-operations.md` erstellt, kanonische Envelopes nachgezogen, Schema-/Batch-Details ausgelagert; 52 Mail-Desk-Tests und quick_validate grün |
