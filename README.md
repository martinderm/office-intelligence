...
- Kartografierung von Cloud-Speicher Junctions und vollautomatische Synchronisation lokaler Markdown-Spiegelungen (Mirrors) mit Multi-Core-Verarbeitung (`--jobs 2`), Hänge-Schutz (`--file-timeout 60`) und automatischem OCR-Fallback via `ocrmypdf` für gescannte PDFs.
