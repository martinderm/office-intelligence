...
> **Skill-Bundle für nachvollziehbare Office-, Wissens- und Verwaltungsarbeit** nach
> dem Dual-Evidence-Ansatz — mit föderierter System Map, hermetischer Testsuite und
> dokumentierten Fachverträgen.

Der Root-[`SKILL.md`](SKILL.md) ist ein Router: Er wählt einen Fach-Desk aus,
ersetzt ihn aber nicht. Das Bundle ist kein Agent-Workspace und bringt keine eigene
Workspace-Control-Plane oder Agent-Lifecycle-Verwaltung mit.
...
> der Batch-Runner und seine Werkzeuge setzen dessen Verträge durch (Review-Hash-Bindung,
> Final-Index-Hardrules, JSON-Manifest-Client, Katalogpflege-Router). Jede Mail
...
> **Lease des ausführenden Harnesses** erforderlich. Lesende Auswertungen sind lockfrei.
> Ein lockfreier Schreiblauf ist nur als ausdrücklich gewählter, dokumentierter
...
Adapter gehören nicht dazu und werden bei Bedarf separat eingebunden:

| Zweck | Adapter (separat einzubinden) |
| --- | --- |
| Meeting-Intake | `fireflies-api`, `zoom-api` |
| Aufgaben-Sync | `todoist-api` |
| Mailbox-Zugriff | Gmail-, Himalaya- oder IMAP-Adapter |

Die fachliche Entscheidung bleibt jeweils beim zuständigen Office-Intelligence-Desk.
...
Für Entwickler, Refactorings und Coding-Agenten (wie Daedalus) existiert eine
vollständige, föderierte System Map nach ICM Form 6:

| Ebene | Karte | Inhalt |
| --- | --- | --- |
| L1 | [Paket System Map](docs/system-map/README.md) | Router, Zusammenspiel der 7 Desks, Data Zones, Bundle-Invarianten |
| L2 | [Mail-Desk System Map](skills/mail-desk/docs/system-map/README.md) | Quarantäne-Engine, Himalaya-Adapter, Batch-Runner/-Verträge, Dossier-Modi |
| L2 | [Cloud-Atlas System Map](skills/cloud-atlas/docs/system-map/README.md) | Filemap-Generierung, Dokumentkonvertierung, OCR-Verzweigung |

---

## 📝 Changelog

Ein kompaktes Änderungsprotokoll liegt im [`CHANGELOG.md`](CHANGELOG.md); abgeschlossene
Feature Requests im Langzeit-Archiv
[`docs/features/_archive.md`](docs/features/_archive.md), aktive im
[FR-Katalog](FEATURE-REQUESTS.md).